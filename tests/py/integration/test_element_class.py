...
class TestElementClass:
    ...
    def test_component_uses_custom_element_class(self, rendered: type[RenderResult]) -> None:
    ...
    def test_component_custom_node_has_trait_methods(self, rendered: type[RenderResult]) -> None:
    ...
    def test_html_element_uses_custom_element_class(self, rendered: type[RenderResult]) -> None:
    ...
    def test_custom_element_class_preserved_on_rerender(self, rendered: type[RenderResult]) -> None:
    ...
    def test_default_element_class_is_element(self, rendered: type[RenderResult]) -> None:
