...
class TestIsRelativeUrl:
    """Tests for _is_relative_url function."""
    ...
    def test_relative_path_with_query_is_relative(self) -> None:
    ...
    def test_relative_path_with_hash_is_relative(self) -> None:
    ...
    def test_http_url_is_not_relative(self) -> None:
    ...
    def test_https_url_is_not_relative(self) -> None:
    ...
    def test_protocol_relative_url_is_not_relative(self) -> None:
    ...
    def test_mailto_scheme_is_not_relative(self) -> None:
    ...
    def test_tel_scheme_is_not_relative(self) -> None:
    ...
    def test_javascript_scheme_is_not_relative(self) -> None:
    ...
    def test_data_scheme_is_not_relative(self) -> None:
    ...
    def test_file_scheme_is_not_relative(self) -> None:
