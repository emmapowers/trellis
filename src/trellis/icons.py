"""Icon names for Lucide React icons.

Provides strongly-typed icon names with IDE autocomplete support.

Usage:
    from trellis.icons import IconName
    from trellis import widgets as w

    w.Icon(name=IconName.CHECK)
    w.Button(text="Save", icon=IconName.SAVE)
"""
